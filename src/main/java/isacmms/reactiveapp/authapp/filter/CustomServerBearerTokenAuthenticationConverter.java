...
package isacmms.reactiveapp.authapp.filter;
...
import isacmms.reactiveapp.todoapp.config.ServerAuthenticationDetailsSource;
	...
	public Mono<Authentication> convert(ServerWebExchange exchange) {
		return Mono.justOrEmpty(token(exchange.getRequest()))
			.map(token -> {
				...
				authenticationToken.setDetails(new ServerAuthenticationDetailsSource().buildDetails(exchange));
